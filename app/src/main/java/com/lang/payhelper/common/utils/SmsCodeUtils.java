package com.lang.payhelper.common.utils;
...
import com.lang.payhelper.common.constant.SmsCodeConst;
...
public class SmsCodeUtils {
     ...
     */
    public static String parseByDefaultRule(Context context, String content, boolean useXSP) {
        String result = "";
        String keywordsRegex;
        if (useXSP) {
            keywordsRegex = loadCodeKeywordsByXSP();
